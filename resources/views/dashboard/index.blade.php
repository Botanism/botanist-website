        ...
        <div class="col-md-8">
            ...
            @if(empty(Auth::user()->discord_id))
                <div class="card">
                    ...
                    <div class="card-body">
                        <a class="btn btn-primary" href="https://discordapp.com/api/oauth2/authorize?client_id=643858878529798166&redirect_uri=http%3A%2F%2Flocalhost%3A8000%2Fdiscord_login&response_type=code&scope=identify%20email%20guilds"><i class="fab fa-discord"></i> {{$Lang->get('dashboard_link_discord')}}</a>
                    </div>
                </div>
            @endif
